...
import './PasswordReset.css'; // Import your custom CSS
            ...
            <form className="card my-4" onSubmit={(e) => handleSubmit(e)}>
              <div className="card-body">
                <div className="form-group">
                  ...
                  <small className="form-text text-muted">Enter the email address you used during registration on Pets Reunite. We will email a link to this address.</small>
                </div>
              </div>
